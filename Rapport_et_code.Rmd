...
MHWeibull_REffect <- function(data, iter = 5 * 10^4,
  ...
  for (i in 1:iter){
    ...
    for (j in 1:6){
      ...
      shape=prop[8]
      top <- log(dnorm(prop,0,100))+sum(dweibull(time1,scale1,shape))+sum(dweibulll(time2,scale2,shape))+sum(1-pweibull(time1,scale1,shape))+sum(1-pweibull(time2,scale2,shape))
      ...
      shape=current[8]
      top <- log(dnorm(prop[j],0,100))+sum(dweibull(time1,scale1,shape))+sum(dweibulll(time2,scale2,shape))+sum(1-pweibull(time1,scale1,shape))+sum(1-pweibull(time2,scale2,shape))
  ...
  shape=prop[8]
  top <- log(dgamma(prop[7],0.0001,10^(4)))+sum(dweibull(time1,scale1,shape))+sum(dweibulll(time2,scale2,shape))+sum(1-pweibull(time1,scale1,shape))+sum(1-pweibull(time2,scale2,shape))
  ...
  scale2=exp(prop[1]+prop[2]*age2+prop[3]*sex+prop[4]*d1+prop[5]*d3+prop[6]*d3+b)
  shape=prop[8]
  top <- log(dgamma(prop[8],1,10^(3)))+sum(dweibull(time1,scale1,shape))+sum(dweibulll(time2,scale2,shape))+sum(1-pweibull(time1,scale1,shape))+sum(1-pweibull(time2,scale2,shape))
